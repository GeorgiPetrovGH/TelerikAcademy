...
function problem3() {
    ...
    if (!isNaN(width) && width >= 0 && !isNaN(height) && height >= 0 && width !== '' && height !== '') {
        document.getElementById('pr3answer').innerHTML = 'The area is: ' + width + '*' + height + ' = ' + area;
        console.log('Problem 3: The area is: ' + width + '*' + height + ' = ' + area);
    } else {
        document.getElementById('pr3answer').innerHTML = 'Width and height must be non-negative numbers';
    }
...
function problem4() {
    ...
    if (!isNaN(problem4Input) && problem4Input % 1 === 0 && problem4Input !== '') {
        ...
        document.getElementById('pr4answer').innerHTML = 'Third digit of ' + problem4Input + ' is 7? --> ' + thirdDigitIs7;
        console.log('Problem 4: Third digit of ' + problem4Input + ' is 7? --> ' + thirdDigitIs7);
    } else {
        document.getElementById('pr4answer').innerHTML = 'Input is not an integer';
    }
...
function problem5() {
    ...
    if (!isNaN(problem5Input) && problem5Input % 1 === 0 && problem5Input !== '') {
        ...
        document.getElementById('pr5answer').innerHTML = 'Number: ' + problem5Input + ', binary representation: ' + binaryNumber + ', third bit: ' + thirdBit;
        console.log('Problem 5:' + problem5Input + ', binary representation: ' + binaryNumber + ', third bit: ' + thirdBit);
    } else {
        document.getElementById('pr5answer').innerHTML = 'Input is not an integer';
    }
...
//Function for padding a string left with a total of 'num' characters 'ch' 
...
function problem6() {
    ...
    if (!isNaN(coorX) && !isNaN(coorY) && coorX !== '' && coorY !== '') {
        document.getElementById('pr6answer').innerHTML = 'The point (' + coorX + ',' + coorY + ') is within the circle K(O, 5) --> ' + withinCircle;
        console.log('Problem 6: The point (' + coorX + ',' + coorY + ') is within the circle K(O, 5) --> ' + withinCircle);
    } else {
        document.getElementById('pr6answer').innerHTML = 'X and Y must be numbers';
    }
...
function problem7() {
    ...
    if (!isNaN(problem7Input) && problem7Input % 1 === 0 && problem7Input !== '') {
        ...
        document.getElementById('pr7answer').innerHTML = problem7Input + ' is prime? --> ' + isPrime;
...
function problem8() {
    ...
    if (!isNaN(sideA) && sideA >= 0 && sideA !== '' && !isNaN(sideB) && sideB >= 0 && sideB !== '' && !isNaN(height) && height >= 0 && height !== '') {
        ...
        document.getElementById('pr8answer').innerHTML = 'The area is: (' + sideA + '+' + sideB + ')/2*' + height + ' = ' + area;
        console.log('Problem 8: The area is: (' + sideA + '+' + sideB + ')/2*' + height + ' = ' + area);
    } else {
        document.getElementById('pr8answer').innerHTML = 'Side A, side B and height must be non-negative numbers';
    }
...
function problem9() {
    ...
    if (!isNaN(coorX) && !isNaN(coorY) && coorX !== '' && coorY !== '') {
        document.getElementById('pr9answer').innerHTML =
            'The point (' + coorX + ',' + coorY + ') is within the circle K((1,1)), 3) and outside the given rectangle --> ' + checkCondition;
        console.log('Problem 9: The point (' + coorX + ',' + coorY + ') is within the circle K((1,1)), 3) and outside the rectangle --> ' + checkCondition);
    } else {
        document.getElementById('pr9answer').innerHTML =
